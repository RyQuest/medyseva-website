                ...
                <div className="slide slide1">
                  ...
                  <div className="container">
                    <div className="header-content">
                      <div className="head">
                        <h2>
                          GET VIDEO CONSULTATION <br />
                          WITH CITY DOCTORS IN <br /> YOUR OWN VILLAGE
                        </h2>
                        <ul>
                          <li>
                            Visit the nearest kendra - Save money and time
                          </li>
                          <li>Consult with the best specialists</li>
                          <li>
                            Safeguard yourself from malpractices of quacks
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="container">
                    <div className="header-content">
                      <div className="head">
                        ...
                        <p>
                          Join Medyseva today to become part of the
                          fast-evolving
                          <br /> medical landscape of India!
                        </p>
                        <ul>
                          <li>
                            Consult in your free time as per your convenience
                          </li>
                  ...
                  <div className="container">
                    <div className="header-content">
                      <div className="head">
                        ...
                        <p>
                          Are you an entrepreneur in rural India? Join Medyseva
                          today
                          <br /> to add a new source of income!
                        </p>
                        <ul>
                          <li>
                            Launch a Medyseva Kendra with minimal investment
                          </li>
                          <li>Maximize your earnings</li>
                          <li>
                            Help your fellow villagers to improve their health
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div className="slide slide4">
                  ...
                  <div className="container">
                    <div className="header-content">
                      <div className="head">
                        <h2>
                          We are supporting National
                          <br /> Digital Health Mission
                        </h2>
                        {/* <p> We are supporting National Digital Health Mission</p> */}
                        <p>
                          Medyseva will soon be a part of ABHA, a Government
                          initiative for creating <br />
                ...
                <div className="col-md-12">
                  <div className="video-head">
                    <div className="video-contain">
                      <a
                        href="assets/img/video/Medyseva.mp4"
                        className="popup-link video"
                      >
                  ...
                  <div className="des">
                    <h2>About Us</h2>
                    <p>
                      Medyseva is a healthcare startup focusing on Telemedicine
                      in Rural India. It seeks to become the ultimate healthcare
                      partner of all citizens such that they can get access to
                      high quality healthcare services with ease and at
                      affordable prices. It bridges the gap between the urban
                      doctors and rural patients through Medyseva Kendras having
                      state-of-the-art technology, which cover the entire
                      spectrum of services that are needed to keep one healthy -
                      from having virtual consultations to getting surgeries,
                      from booking diagnostic tests to digitizing medical
                      records.
                    </p>
                    <div className="col-md-12">
                      <div className="btn1">
                        <a data-bs-toggle="modal" data-bs-target="#about-us">
                          Know More
                        </a>
                      </div>
                    </div>
                      ...
                      <div className="slide">
                        <div className="h-100">
                          <div className="service-card">
                            <div className="card">
                              <img
                                src="assets/img/consattation.png"
                              ...
                              <div className="card-body">
                                ...
                                <p className="card-text">
                                  India’s best doctors across various
                                  specialties provide video consultation at
                                  affordable prices on the Medyseva platform.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="service-card">
                            <div className="card">
                              ...
                              <div className="card-body">
                                <h4>Pathology</h4>
                                <p className="card-text">
                                  Samples are collected at our centers and
                                  tested at our local associated labs. The
                                  patient does not need to deliver samples or
                                  collect reports himself.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="service-card">
                            <div className="card">
                              ...
                              <div className="card-body">
                                <h4>Radiology</h4>
                                <p className="card-text">
                                  We have collaborations with the best radiology
                                  centers in the nearest cities. The patient is
                      ...
                      <div className="slide">
                        <div className="h-100">
                          <div className="service-card">
                            <div className="card">
                              <img
                                src="assets/img/hospitalzation.png"
                                className="card-img-top"
                                alt="..."
                              />
                              <div className="card-body">
                                ...
                                <p className="card-text">
                                  For a patient who needs to be hospitalized,
                                  Medyseva assists the patient in transportation
                                  facilities to the nearest associated hospital
                                  and through the formalities and processes of
                                  the admission.
                                </p>
                              </div>
                            </div>
                      ...
                      <div className="slide">
                        <div className="h-100">
                          <div className="service-card">
                            <div className="card">
                              <img
                                src="assets/img/image_2022_05_12T13_39_41_049Z.png"
                                className="card-img-top"
                                alt="..."
                              />
                              <div className="card-body">
                                <h4>Ambulance</h4>
                                <p className="card-text">
                                  We provide ambulance service for patients who
                                  need to go to our associated or any other
                                  hospital.
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="service-card">
                            <div className="card">
                              ...
                              <div className="card-body">
                                ...
                                <p className="card-text">
                                  For patients who are advised bedrest or who
                                  need to stay at home for their long recovery
                                  process, we provide trained nurses and other
                                  care- takers.
                                </p>
                              </div>
                            </div>
              ...
              <div className="row">
                ...
                <div className="col-sm-3">
                  <div className="specialist-box">
                    <img
                      className="doc-img"
                      src="assets/img/pngtree-cartoon-hand-drawn-gynecology-explaining-plant-illustration-png-image_5512059.jpg"
                    />
                    <h3>Gynaecology</h3>
                  </div>
                </div>
                <div className="col-sm-3">
                  <div className="specialist-box">
                    <img
                      className="doc-img"
                      src="assets/img/image_2022_06_08T13_24_15_286Z.png"
                    />
                    <h3>MD Medicine</h3>
                  </div>
                </div>
                ...
                <div className="col-sm-3">
                  <div className="specialist-box">
                    <img
                      className="doc-img"
                      src="assets/img/neuro.svg.med.png.crdownload"
                    />
                    <h3>Neurology</h3>
                  </div>
                </div>
          ...
          <section id="counter">
            <div className="container">
              <div className="row">
                ...
                <div className="col-lg-3 stats col-6">
                  <img src="assets/img/counter/one.png" />
                  <div className="counting" id="plus">
                    2500
                  </div>
                  <h5>CONSULTATIONS</h5>
                </div>
              ...
              <div className="row">
                <div className="col-md-4 col-sm-6 col-12">
                  <div className="team-medi-box">
                    ...
                    <h6 style={{ color: "", fontWeight: "bold" }}>
                      FOUNDER/CEO
                    </h6>
                    <div className="other-info-box">
                      <p>MBBS, MBA, DEM</p>
                      <p>10+ years experience in healthcare</p>
                      <p>2+ years experience in rural fintech</p>
                    </div>
                    <div className="text-center">
                      <a
                        href="https://www.linkedin.com/in/dr-vishesh-kasliwal/?trk=public_profile_browsemap&originalSubdomain=in&original_referer="
                        target={"_blank"}
                      >
                ...
                <div className="col-md-4 col-sm-6 col-12">
                  <div className="team-medi-box">
                    ...
                    <div className="text-center">
                      <a
                        href="https://www.linkedin.com/in/rachita-kasliwal89/?originalSubdomain=in"
                        target={"_blank"}
                      >
                        <img src="assets/img/in.png" />
                      </a>
                ...
                <div className="col-md-4 col-sm-6 col-12">
                  <div className="team-medi-box">
                    ...
                    <div className="text-center">
                      <a
                        href="https://www.linkedin.com/in/dr-rashmi-patidar-367398238/"
                        target={"_blank"}
                      >
                        <img src="assets/img/in.png" />
                      </a>
              ...
              <div className="row" style={{ justifyContent: "center" }}>
                <div className="col-md-4 col-sm-6 col-12">
                  <div className="team-medi-box">
                    <img
                      className="doc-img"
                      src="assets/img/Medyseva_Mehul (1).png"
                    />
                    <h3>MEHUL JAIN</h3>
                    <h6>TECHNOLOGY</h6>
                    <div className="other-info-box">
                    ...
                    <div className="text-center">
                      <a
                        href="https://www.linkedin.com/in/mehul-jain-13269112/"
                        target={"_blank"}
                      >
                        <img src="assets/img/in.png" />
                      </a>
                ...
                <div class="col-md-4 col-sm-6 col-12">
                  <div class="team-medi-box">
                    ...
                    <div class="text-center">
                      <a
                        href="https://www.linkedin.com/in/ca-umanshi-agrawal/"
                        target={"_blank"}
                      >
                        <img src="assets/img/in.png" />
                      </a>
              ...
              <div className="row">
                <div className="col-sm-3">
                  <div className="team-medi-box">
                    ...
                    <h6>Managing Director Vishesh Jupiter Hospital, Indore</h6>
                  </div>
                </div>
                <div className="col-sm-3">
                  <div className="team-medi-box">
                    ...
                    <h3>Mr. Ajay Jain</h3>
                    <h6>
                      Director - CN group of Companies, Ranchi IIT Kharagpur
                      Alumnus
                    </h6>
                  </div>
                </div>
                ...
                <div className="col-sm-3">
                  <div className="team-medi-box">
                    ...
                    <h6>
                      A company secretary having 19 + years in finance sector,
                      mentoring and guiding startups since many years
                    </h6>
                  </div>
                </div>
              </div>
                        ...
                        <div className="h-100">
                          ...
                          >
                            <video
                              ...
                              width={320}
                              height={240}
                              src="assets/img/video/test1.mp4"
                            ></video>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="h-100">
                          ...
                          >
                            <video
                              ...
                              width={320}
                              height={240}
                              src="assets/img/video/test2.mp4"
                            ></video>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="h-100">
                          ...
                          >
                            <video
                              ...
                              width={320}
                              height={240}
                              src="assets/img/video/test3.mp4"
                            ></video>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="h-100">
                          ...
                          >
                            <video
                              ...
                              width={320}
                              height={240}
                              src="assets/img/video/test4.mp4"
                            ></video>
                          </div>
                        </div>
                      </div>
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-md-8">
                  <div className="head">
                    <h2>
                      Doctors Can Download <br />
                      Medyseva App
                    </h2>
                    <p>
                      A powerful app that lets you manage and grow <br />
                      your practice.
                    </p>
                  </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="content-des">
                  ...
                  <p>
                    Citizens in rural India face many challenges when it comes
                    to medical treatment. They have to either spend a lot of
                    money and time going to nearby cities for treatment or fall
                    back on local doctors who may be unqualified/
                    underqualified. They might not be comfortable with mobile
                    apps. Medyseva helps them to overcome these problems.
                  </p>

                  <p>
                    Like many startup stories, our journey too began during the
                    Covid pandemic. We realized that our friends and relatives
                    in rural areas did not have access to good doctors and were
                    unaware of or uncomfortable with mobile apps. That is when
                    Medyseva was born, providing video consultation through our
                    phygital centers – an ideal mix of online and offline. In
                    July 2021, we launched two Medyseva Kendras in Madhya
                    Pradesh and since then have been expanding our reach across
                    Central India.
                  </p>

                  <p>
                    <span>Mission: </span>To ensure that every rural citizen of
                    India has access to high quality doctors and medical
                    services at their convenience and at affordable prices.
                  </p>

                  <p>
                    <span>Vision:</span> To be the nearest, affordable and the
                    most reliable healthcare destination for the rural citizens
                    of India.
                  </p>
                  <p>
                    ...
                    <br />
                    <ul>
                      <li>Global Hackathon conducted by MERI College, Delhi</li>
                      <li>
                        Global Entrepreneur summit 2022 conducted by Jai Hind
                        College, Mumbai.
                      </li>
                      <li>Heart Pitch competition conducted by TiE MP</li>
                      <li>Hubli TiECON Business Pitch Competition</li>
                    </ul>
              ...
              <div className="modal-body">
                <div class="row">
                  <div class="col-md-6 col-6">
                    <button
                      className={joinTab === 1 ? "active" : ""}
                      onClick={() => setJoinTab(1)}
                    >
                      Doctor
                    </button>
                  </div>
                  <div class="col-md-6 col-6">
                    <button
                      className={joinTab === 2 ? "active" : ""}
                      onClick={() => setJoinTab(2)}
                    >
                      Own a Center
                    </button>
                  </div>
